...
def test(f1, f2, wgs):
    cmd = '../wavefront_baseline -pid 1 -WFO2OCL -fP ../data/{} -fT ../data/{} -wgs {} -v -k -1  -pp 10'.format(f1,f2, wgs)
    #print(cmd)
...
df = pd.read_csv('baseline.txt', skiprows=1)
...
# LAUNCH WITH : nohup python3 -u test_baseline.py > new_baseline.txt &
